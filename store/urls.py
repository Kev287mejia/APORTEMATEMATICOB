...
urlpatterns = [
    ...
    path('contacto.html', views.contacto_view, name='contacto_html'),
    
    path('pedido/', views.pedido_view, name='pedido'),
    path('pedido.html', views.pedido_view, name='pedido_html'),
    
    path('activador/', views.activador_view, name='activador'),
    path('activador.html', views.activador_view, name='activador_html'),
    ...
    path('api/admin/generate-code/', views.admin_generate_code, name='admin_generate_code'),
